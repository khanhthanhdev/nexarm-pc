...
# Embedded file name: nexarm_qt\ui\servo_advanced_tab.py
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QGroupBox, QPushButton, QLabel, QSpinBox, QGridLayout, QComboBox, QScrollArea
...
class ServoAdvancedTab(QWidget):
    ...
    def _build_servo_adv(self, r):
        ...
        pid_lay.addWidget(QLabel("P:"))
        pid_lay.addWidget(self.spin_p)
        pid_lay.addWidget(QLabel("I:"))
        pid_lay.addWidget(self.spin_i)
        pid_lay.addWidget(QLabel("D:"))
        pid_lay.addWidget(self.spin_d)
        pid_lay.addWidget(QLabel("MinF:"))
        pid_lay.addWidget(self.spin_minf)
    ...
    def _build_baud(self, r):
        ...
        self.combo_baud.addItems(['0: 1M', '1: 500K', '2: 250K', '4: 115200', '5: 76800', '6: 57600', 
         '7: 38400'])
    ...
    def set_baud_all(self):
        text = self.combo_baud.currentText()
        baud_code = int(text.split(":")[0])
        self.comm_manager.send_sys(CMD_SET_BAUD, [254, baud_code])
    ...
    def set_max_torque(self):
        ...
        self.comm_manager.send_sys(CMD_SET_MAX_TORQUE, [sid, val & 255, val >> 8 & 255])
