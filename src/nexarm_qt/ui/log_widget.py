...
# Embedded file name: nexarm_qt\ui\log_widget.py
...
class LogWidget(QWidget):
    ...
    def update_language(self, lang):
        self.lang = lang
        if hasattr(self, "lbl_hex_title"):
            self.lbl_hex_title.setText(STRINGS[lang]["grp_hex_log"])
        if hasattr(self, "lbl_txt_title"):
            self.lbl_txt_title.setText(STRINGS[lang]["grp_txt_log"])
        if hasattr(self, "btn_clear_hex"):
            self.btn_clear_hex.setText(STRINGS[lang].get("btn_clear_log", "一键清除"))
        if hasattr(self, "btn_export_hex"):
            self.btn_export_hex.setText(STRINGS[lang].get("btn_export_log", "一键导出"))
        if hasattr(self, "btn_clear_txt"):
            self.btn_clear_txt.setText(STRINGS[lang].get("btn_clear_log", "一键清除"))
        if hasattr(self, "btn_export_txt"):
            self.btn_export_txt.setText(STRINGS[lang].get("btn_export_log", "一键导出"))
