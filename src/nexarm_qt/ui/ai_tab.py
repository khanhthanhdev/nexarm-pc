...
# Embedded file name: nexarm_qt\ui\ai_tab.py
...
class AITab(QWidget):
    ...
    def _bind_pair(self, btn_start, btn_stop, cmd_start, cmd_stop):
        ...
        def on_start():
            self.comm_manager.send_packet(255, cmd_start[0], cmd_start[1])
            self._set_active(btn_start, btn_stop)

        def on_stop():
            self.comm_manager.send_packet(255, cmd_stop[0], cmd_stop[1])
    ...
    def init_tracking_ui(self):
        ...
        self._bind_pair(self.btn_face_start, self.btn_face_stop, (41, [1]), (41, [0]))
        ...
        def color_start(btn, cmd_args):
            ...
            def fn():
                self.comm_manager.send_packet(255, 40, cmd_args)
        ...
        self.btn_color_red.clicked.connect(color_start(self.btn_color_red, [1, 1]))
        self.btn_color_green.clicked.connect(color_start(self.btn_color_green, [1, 2]))
        self.btn_color_blue.clicked.connect(color_start(self.btn_color_blue, [1, 3]))

        def color_stop():
            self.comm_manager.send_packet(255, 40, [0, 0])
            for b in self._color_btns:
                b.setStyleSheet("")
        ...
        self._bind_pair(self.btn_tag_start, self.btn_tag_stop, (43, [1]), (43, [0]))
        ...
        self._bind_pair(self.btn_gesture_start, self.btn_gesture_stop, (81, [1]), (81, [0]))
    ...
    def init_grabbing_ui(self):
        ...
        self._bind_pair(self.btn_tag_grab_start, self.btn_tag_grab_stop, (44, [1]), (44, [0]))
        ...
        self._bind_pair(self.btn_waste_start, self.btn_waste_stop, (48, [1]), (48, [0]))
        ...
        def cgrab_start(btn, color_id):
            ...
            def fn():
                self.comm_manager.send_packet(255, 46, [1, color_id])
        ...
        self.btn_cgrab_red.clicked.connect(cgrab_start(self.btn_cgrab_red, 1))
        self.btn_cgrab_green.clicked.connect(cgrab_start(self.btn_cgrab_green, 2))
        self.btn_cgrab_blue.clicked.connect(cgrab_start(self.btn_cgrab_blue, 3))

        def cgrab_stop():
            self.comm_manager.send_packet(255, 46, [0])
            for b in self._cgrab_btns:
                b.setStyleSheet("")
        ...
        self._bind_pair(self.btn_llm_start, self.btn_llm_stop, (47, [1]), (47, [0]))
    ...
    def send_cmd(self, cmd, args):
        self.comm_manager.send_packet(255, cmd, args)
