...
# Embedded file name: nexarm_qt\ui\arm_3d_window.py
...
class Arm3DWindow(QMainWindow):
    ...
    def __init__(self, comm_manager, lang='zh', parent=None):
        ...
        btn_close.setStyleSheet("background-color: #3C3F52; color: white; padding: 6px 15px; font-size: 10pt; font-weight: bold; border: 1px solid #5A5D6E; border-radius: 4px; min-height: 32px;")
