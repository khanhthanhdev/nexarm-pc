...
# Embedded file name: nexarm_qt\constants.py
CMD_SYS_HEAD = 255
...
CMD_ESPNOW_SET_ROLE = CMD_ESPNOW_SYNC_CTRL
CMD_ESPNOW_ENABLE = CMD_ESPNOW_SYNC_CTRL
CMD_ESPNOW_SYNC = CMD_ESPNOW_SYNC_CTRL
CMD_ESPNOW_SET_MAC = CMD_SET_PEER_MAC
CMD_ESPNOW_SCAN = CMD_SCAN_WIFI_CHANNELS
